...
<div class="container-fluid">
				...
				<div class="user-wrapper text-center">						
					...
					<div class="user-avatar text-center">
						...
						<?php if ($top_user_pins_pos = ipin_top_user_by_pins($user_info->ID)) { ?>
							<a id="user-profile-top-pin" class="pull-right" href="<?php echo home_url('/top-users/'); ?>"><span class="label label-warning top-user-count-alt2"><?php _e('Most Pins', 'ipin'); ?> #<?php echo $top_user_pins_pos; ?></span></a>
						<?php } ?>
					</div>
	...
	<div id="userbar" class="row">
		<ul class="nav">
			...
			<li<?php if (isset($_GET['view']) && $_GET['view'] == sanitize_title('pins')) { echo ' class="active"'; } ?>><a href="<?php echo get_author_posts_url($user_info->ID); ?>?view=pins"><?php _e('Pins', 'ipin'); ?><br /><strong><?php echo $pins_count; ?></strong></a></li>
			<li<?php if (isset($_GET['view']) && $_GET['view'] == sanitize_title('likes')) { echo ' class="active"'; } ?>><a href="<?php echo get_author_posts_url($user_info->ID); ?>?view=likes"><?php _e('Likes', 'ipin'); ?><br /><strong><?php echo $likes_count; ?></strong></a></li>
			<li<?php if (isset($_GET['view']) && $_GET['view'] == sanitize_title('followers')) { echo ' class="active"'; } ?>><a href="<?php echo get_author_posts_url($user_info->ID); ?>?view=followers"><?php _e('Followers', 'ipin'); ?><br /><strong id="ajax-follower-count"><?php echo $followers_count; ?></strong></a></li>
			<li style="margin-right:0;"<?php if (isset($_GET['view']) && $_GET['view'] == sanitize_title('following')) { echo ' class="active"'; } ?>><a href="<?php echo get_author_posts_url($user_info->ID); ?>?view=following"><?php _e('Following', 'ipin'); ?><br /><strong><?php echo $following_count; ?></strong></a></li>
			<li>
...
<?php 
if (isset($_GET['view']) && $_GET['view'] == sanitize_title('pins')) {
...
} else if (isset($_GET['view']) && $_GET['view'] == sanitize_title('likes')) {
...
} else if (isset($_GET['view']) && ($_GET['view'] == sanitize_title('followers') || $_GET['view'] == sanitize_title('following'))) {
	if ($_GET['view'] == sanitize_title('followers')) {
		$followers = get_user_meta($user_info->ID, '_Followers User ID');
	} else if ($_GET['view'] == sanitize_title('following')) {
		...
		<div id="navigation">
			<ul class="pager">				
				...
				<li id="navigation-previous">
					<?php if ($_GET['view'] == sanitize_title('followers')) { ?>
					<a href="<?php echo get_author_posts_url($user_info->ID); ?>?view=<?php echo sanitize_title('followers'); ?>&amp;pnum=<?php echo $pnum-1; ?>"><?php _e('&laquo; Previous', 'ipin') ?></a>
					<?php } else if ($_GET['view'] == sanitize_title('following')) { ?>
					<a href="<?php echo get_author_posts_url($user_info->ID); ?>?view=<?php echo sanitize_title('following'); ?>&amp;pnum=<?php echo $pnum-1; ?>"><?php _e('&laquo; Previous', 'ipin') ?></a>
					<?php } ?>
				</li>
				<?php } ?>
				...
				<li id="navigation-next">
					<?php if ($_GET['view'] == sanitize_title('followers')) { ?>
					<a href="<?php echo get_author_posts_url($user_info->ID); ?>?view=<?php echo sanitize_title('followers'); ?>&amp;pnum=<?php echo $pnum+1; ?>"><?php _e('Next &raquo;', 'ipin') ?></a>
					<?php } else if ($_GET['view'] == sanitize_title('following')) { ?>
					<a href="<?php echo get_author_posts_url($user_info->ID); ?>?view=<?php echo sanitize_title('following'); ?>&amp;pnum=<?php echo $pnum+1; ?>"><?php _e('Next &raquo;', 'ipin') ?></a>
					<?php } ?>
				</li>
				<?php } ?>
			</ul>
