	...
	<?php if(function_exists('wp_pagenavi') && $_GET['view'] != sanitize_title('likes')) { ?>
	...
	<div id="navigation">
		<ul class="pager">
			<?php if (isset($_GET['view']) && $_GET['view'] == sanitize_title('likes')) { //from author page - likes section ?>
				<?php
				...
				<div id="navigation">
					<ul class="pager">
						...
						<li id="navigation-previous">
							<a href="<?php echo home_url('/' . $wp_rewrite->author_base . '/' . $username . '/?view=' . sanitize_title('likes')); ?>&amp;pnum=<?php echo $pnum-1; ?>"><?php _e('&laquo; Previous', 'ipin'); ?></a>
						</li>
						<?php } ?>
						
						<?php if ($maxpage != 1 && $maxpage != $pnum) { ?>
						<li id="navigation-next">
							<a href="<?php echo home_url('/' . $wp_rewrite->author_base . '/' . $username . '/?view=' . sanitize_title('likes')); ?>&amp;pnum=<?php echo $pnum+1; ?>"><?php _e('Next &raquo;', 'ipin'); ?></a>
						</li>
						<?php } ?>
					</ul>
				</div>
