...
class Options_Framework_Admin {
	...
	static function menu_settings() {
		...
		$menu = array(
            ...
            'page_title' => __( 'گزینه های پوسته', 'options-framework'),
			'menu_title' => __('گزینه های پوسته', 'options-framework'),
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox">
				...
				<div id="optionsframework-submit">
					<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'ذخیره گزینه ها', 'options-framework' ); ?>" />
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'بازیابی پیشفرض', 'options-framework' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'برای بازیابی اطلاعات پیشفرض تائید کنید. همه تنظیمات پوسته از بین خواهند رفت!', 'options-framework' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
	...
	function validate_options( $input ) {
		...
		if ( isset( $_POST['reset'] ) ) {
			add_settings_error( 'options-framework', 'restore_defaults', __( 'گزینه ها پیشفرض بازیابی گردیدند.', 'options-framework' ), 'updated fade' );
	...
	function save_options_notice() {
		add_settings_error( 'options-framework', 'save_options', __( 'گزینه ها ذخیره گردیدند.', 'options-framework' ), 'updated fade' );
	}
